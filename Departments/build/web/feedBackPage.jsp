  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        ...
        <form method="post" action="feedBack" style="margin-left: 150px;margin-top: 60px">
    ...
    <option>Done but not Satisfied</option>
        ...
        <button class="btn btn-primary" id="butty" style="margin-left: 120px;margin-top: 45px;font-size: 18px;font-family: serif;"><i>Send</i></button>
        </form>
        </body>
</html>
